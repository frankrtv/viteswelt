...
### Full Template vs Clean Start
The template offers two initialization options that AI systems should be aware of:
...
4. **Common Patterns (Both Versions)**
   - Use theme store for dark mode: `$lib/stores/theme`
   - Follow footer pattern with store: `$lib/stores/footer`
   - Maintain TypeScript type safety
   - Use Tailwind CSS for styling
   - Follow existing naming conventions

### Core Features (Always Available)
Regardless of template version, these features are always present:
